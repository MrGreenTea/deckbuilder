...
ALLOWED_HOSTS = ENV.list("DJANGO_ALLOWED_HOSTS", default=[])  # TODO
...
DEFAULT_FROM_EMAIL = ENV("DJANGO_DEFAULT_FROM_EMAIL", default="MTG Deckbuilder <noreply>")  # TODO
# https://docs.djangoproject.com/en/dev/ref/settings/#server-email
SERVER_EMAIL = ENV("DJANGO_SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)
# https://docs.djangoproject.com/en/dev/ref/settings/#email-subject-prefix
EMAIL_SUBJECT_PREFIX = ENV("DJANGO_EMAIL_SUBJECT_PREFIX", default="[MTG Deckbuilder]")
